<?php 
    ...
    if(isset($_GET["delete"]))
    {
        ...
        $sql = "DELETE FROM student_enqury WHERE id=$delete";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-hover" id="usetTable">
                                            ...
                                            <?php if(!empty($arr_users)) { ?>
                                                <?php foreach($arr_users as $user) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $user['semail']; ?></td>
                                                        <td><?php echo $user['snumber']; ?></td>
                                                        <td><?php echo $user['smessage']; ?></td>
